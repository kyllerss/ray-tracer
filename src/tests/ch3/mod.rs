...
mod tests {
    ...
    #[test]
    fn test21_scaling_matrix_applied_to_point() {
    ...
    #[test]
    fn test22_scaling_matrix_applied_to_vector() {
        let t = Matrix::new_scaling(2.0, 3.0, 4.0);
    ...
    #[test]
    fn test23_multiplying_by_inverse_of_scaling_matrix() {
    ...
    #[test]
    fn test24_reflection_is_scaling_by_a_negative_value() {
